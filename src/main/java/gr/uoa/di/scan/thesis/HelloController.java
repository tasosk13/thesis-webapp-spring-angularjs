...
public class HelloController {
	...
	class WelcomeMessagesUtil {
		...
		public WelcomeMessagesUtil(String header, String message) {
			this.header = header;
	...
	public @ResponseBody
	List<WelcomeMessagesUtil> welcome() {
		List<WelcomeMessagesUtil> messageList = new ArrayList<WelcomeMessagesUtil>();
		messageList
				.add(new WelcomeMessagesUtil(
		...
		System.out.println("Responding on endpoint request /home/welcome");
		return messageList;
	}
